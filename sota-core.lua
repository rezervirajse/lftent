...
SOTA_CONFIG_PrivateAuctions		= 1;	-- 1: suppress auction announcements, 0: allow
SOTA_CONFIG_IgnoreBidDKP		= 1;	-- 1: allow bids regardless of DKP balance
...
function SOTA_GetStartingDKP()
	...
	-- Removing this because we dont need it
